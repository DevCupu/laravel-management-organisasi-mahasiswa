    ...
    <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('organizations.show', $organization) }}"
                                class="text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors">{{ $organization->name }}</a>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
            ...
            <p class="mt-1 text-sm text-gray-500">
                Perbarui informasi organisasi {{ $organization->name }}
            </p>
        </div>
                ...
                @if ($organization->logo_path)
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Logo organisasi saat ini</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="acronym" name="acronym"
                                value="{{ old('acronym', $organization->acronym) }}" required
                        ...
                        <div>
                            ...
                            <select id="category" name="category" required
                                ...
                                <option value="himpunan"
                                    {{ old('category', $organization->category) === 'himpunan' ? 'selected' : '' }}>
                                    Himpunan Mahasiswa</option>
                                <option value="ukm"
                                    {{ old('category', $organization->category) === 'ukm' ? 'selected' : '' }}>Unit
                                    Kegiatan Mahasiswa</option>
                                <option value="ormawa"
                                    {{ old('category', $organization->category) === 'ormawa' ? 'selected' : '' }}>
                                    Organisasi Kemahasiswaan</option>
                                <option value="bem"
                                    {{ old('category', $organization->category) === 'bem' ? 'selected' : '' }}>Badan
                                    Eksekutif Mahasiswa</option>
                                <option value="osis"
                                    {{ old('category', $organization->category) === 'osis' ? 'selected' : '' }}>OSIS
                                </option>
                            </select>
                            @error('category')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="status" name="status" required
                                ...
                                <option value="active"
                                    {{ old('status', $organization->status) === 'active' ? 'selected' : '' }}>Aktif
                                </option>
                                <option value="inactive"
                                    {{ old('status', $organization->status) === 'inactive' ? 'selected' : '' }}>Tidak Aktif
                                </option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Deskripsi singkat tentang organisasi, visi, misi, dan tujuan...">{{ old('description', $organization->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="social_media" name="social_media"
                                value="{{ old('social_media', $organization->social_media) }}"
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3"
                            ...
                            placeholder="Alamat lengkap sekretariat organisasi...">{{ old('address', $organization->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div id="upload-placeholder">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">Kosongkan jika tidak ingin mengubah logo</p>
                                </div>
                            </div>
                        </div>
                        @error('logo')
